...
let moduleData = [
    ...
    },
    {
        ...
        tooltip: "The Telemetry module features a large LCD screen that provides a ton of data regarding the status of the current vessel, such as fuel levels, orbit information, and maneuver data. Four buttons allow the user to select which display mode is currently active.",
        has: ['Telemetry']
    }
];